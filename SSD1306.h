...
/* 3 and 4 wire SPI is not implemented ---------------------------------------*/
//#define INTERFACE_4WIRE_SPI
//#define INTERFACE_3WIRE_SPI
#define	INTERFACE_IIC
/* Exported functions ------------------------------------------------------- */

extern void ssd1306_clear_screen(void);
extern void ssd1306_fill_in_screen(void);
...
extern void ssd1306_display_num_ext(uint8_t chXpos, uint8_t chYpos, uint32_t chNum, uint8_t chLen,uint8_t chSize, uint8_t chMode);
